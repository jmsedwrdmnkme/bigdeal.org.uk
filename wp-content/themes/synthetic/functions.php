...
function synthetic_setup() {
  ...
  register_nav_menus( array( 'main-menu' => esc_html__( 'Main Menu', 'synthetic' ) ) );
}
add_action( 'wp_enqueue_scripts', 'synthetic_load_scripts' );
function synthetic_load_scripts() {
  wp_enqueue_style( 'synthetic-style', get_stylesheet_uri() );
  wp_enqueue_script( 'jquery' );
}
add_action( 'wp_footer', 'synthetic_footer_scripts' );
function synthetic_footer_scripts() {
?>
  <script>
